<template>
  <div class="edit-project">
    <div class="edit-project_content">
      <div class="edit-project_content_icon">
        <font-awesome-icon :icon="['fas','file-alt']" class="view-icon"></font-awesome-icon>
      </div>

      <div class="edit-project_content-grid">
        ...
        <div class="fields">
          <div class="field">
            ...
            <el-pagination
              ...
              :pageSize="pageSize"
              :total="connectionsShown ? connectionsShown.length : 0"
...
<style src="./edit-project.scss" lang="scss"></style>