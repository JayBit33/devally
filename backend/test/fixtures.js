...
const projects = [
  {
    ...
    is_active: true,
    is_featured: true,
    is_seeking_allys: true,
    hiring_options: ["Shares","Flat Rate"],
    viewable_regions: ["US","Europe"],
    funding_types: ["Bootstrapped"],
  },
  {
    creator_id: "3",
    team_member_ids: [12,5,7],
    name: 'Cash App',
    category: 'Mobile App',
    ...
    hiring_options: ["Shares"],
    viewable_regions: ["US"],
    funding_types: ["Venture Capital"],
  },
  {
    creator_id: "5",
    team_member_ids: [11,8,0],
    name: 'Task Manager',
    category: 'SAAS',
    ...
    hiring_options: ["Flat Rate"],
    viewable_regions: ["US","South America"],
    funding_types: ["Crowdfunding"],
  },
  {
    creator_id: "6",
    team_member_ids: [9,10,13],
    name: 'Get It Now',
    category: 'Ecommerce',
    ...
    is_seeking_allys: true,
    hiring_options: ["Shares","Flat Rate"],
    viewable_regions: ["US","South America","Africa","Asia","Europe"],
    funding_types: ["Friends & Family"],
  },
  {
    creator_id: "16",
    team_member_ids: [15,1,13],
    name: 'MediaTree',
    category: 'Website',
