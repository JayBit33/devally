...
const dev_accounts = [
  ...
  { id: 2180, username: 'betho89', firstname: 'Beth', lastname: 'Antoitte', accountType: ['Entrepreneur'], skills: ['Java', 'Spring Boot', 'Backend Developer'], hiringOptions: ['Hourly','Shares'], rating: 4, profileImage: 'profile2.jpg'},
